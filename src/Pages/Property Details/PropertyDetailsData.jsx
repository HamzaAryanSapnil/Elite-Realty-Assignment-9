...
const PropertyDetailsData = ({item}) => {
    console.log(item);
    const {segment_name, image_url, price, status, area, location, facilities}=item;
  return (
    <div>
      <div className="dark:bg-gray-100 dark:text-gray-900">
	<div className="container grid grid-cols-12 mx-auto dark:bg-gray-50">
		<div className="bg-no-repeat bg-cover dark:bg-gray-300 col-span-full lg:col-span-4" style={{backgroundImage: {image_url}, backgroundPosition: "center center", backgroundBlendMode: "multiply", backgroundSize: "cover"}}></div>
