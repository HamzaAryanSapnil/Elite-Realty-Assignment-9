...
const EstateCards = () => {
  ...
  return (
    <div className="w-full">
      <div>
        <h1 className="text-5xl font-bold mb-4 text-center font-mulish text-descolor">Our Properties</h1>
        <p className="text-center my-4 text-descolor70 " >
          Welcome to <span className="text-lg font-medium text-signBtn font-manrope">Elite Realty</span>,
          ...
          sprawling estates, in prime locations.
        </p>
      </div>
      <div className="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-y-5 gap-x-3 my-10">
        {data.map((item) => (
